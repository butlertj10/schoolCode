...
private:
  ...
  unsigned int currentProcess; // current thread progessing
  unsigned int totalTurns; // total turns

  SpinLock *spinLock; // creates spinlock
...
public:
  ...
  public:
    ...
    Ticket(unsigned int t, unsigned int i) : ticket{t}, initial_turn{i}
    { /*Empty body */}
  };
