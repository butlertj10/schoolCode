...
bool LoadFiles()
{
    ...
    if(BallBounceSound == NULL)
        {
            printf("Bounce sound did not load.");
            return false;
        }
    if(BallSpawnSound == NULL)
        {
            printf("Spawn sound did not load.");
            return false;
        }
    if(PlayerScoreSound == NULL)
        {
            printf("Player score sound did not load.");
            return false;
        }
    if(EnemyScoreSound == NULL)
        {
            printf("Enemy Score sound did not load.");
            return false;
        }
...
void UpdateEnemy()
{
    ...
    if(keys[SDLK_UP])
        EnemyPaddleRect.y -= PADDLE_SPEED;
...
void DrawGame()
{
    ...
    DrawImage(EnemyPaddleImage, Backbuffer, PlayerPaddleRect.x, PlayerPaddleRect.y);
    DrawImage(PlayerPaddleImage, Backbuffer, EnemyPaddleRect.x, EnemyPaddleRect.y);
