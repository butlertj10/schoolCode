...
*			Clear Screen
*		END IF
*		If array as not been filled
*   		Input a player's last name or QUIT to quit
*			Input that player's at-bats and hits
*			Clear Screen
*		ELSE
*			Allow user to input a player's last name or QUIT to quit
*			Set player name equal to quit value
*			Display message that max outputs have been reached
*			Pause screen
*			Clear screen
*   END WHILE
