...
//local variables
     ...
     float Items_Sold1;  //Number of items sold by employee 1

     float Items_Sold2;  //Number of items sold by employee 2

     float Items_Sold3;  //Number of items sold by employee 3
...
//Calculate % Sold For Each Name
	 Percent1 = (Items_Sold1/Total) * 100.0;
	 Percent2 = (Items_Sold2/Total) * 100.0;
	 Percent3 = (Items_Sold3/Total) * 100.0;
	 
//Display Sales Report
    cout << "\n\n\n" << setw(52) << "Quarterly Sales Report\n\n";
    cout << setw(19) <<  "Name"  << setw(25) << "Items Sold" << setw(23) << "Pct Sold\n"
    	 << setw(19) <<  "----"  << setw(25) << "----------" << setw(24) << "--------\n\n"
    	 << setw(18) <<  Name1   << setw(22) << Items_Sold1 << setw(26) << setprecision(3) << Percent1 << "\n"
    	 << setw(18) <<  Name2   << setw(22) << Items_Sold2 << setw(26) << setprecision(3) << Percent2 << "\n"
		 << setw(18) <<  Name3   << setw(22) << Items_Sold3 << setw(26) << setprecision(3) << Percent3 << "\n\n"
